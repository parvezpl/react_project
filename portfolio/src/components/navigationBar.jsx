...
function NavigationBar() {
    ...
    const [lsmenu, setLsmenu]= useState(true)
    return (
        <>
            <nav className="bg-white border-gray-200 dark:bg-gray-900">
            <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            <a href="" className="flex items-center">
                <img src="/src/assets/logo/2.png" className="w-20 mr-3" alt="Flowbite Logo" />
                <span className="self-center text-1xl font-semibold whitespace-nowrap dark:text-white">PARVEZ ALAM</span>
            </a>
            <div className=" relative flex items-center md:order-2">
                <LogoLayout btn={logobtn} />
                <button type="button" className="flex mr-3 text-sm bg-gray-800 rounded-full md:mr-0 focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600" id="user-menu-button" aria-expanded="false" data-dropdown-toggle="user-dropdown" data-dropdown-placement="bottom">
                    <span className="sr-only">Open user menu</span>
    {/* logolayout function  */}
                    <img onClick={()=>setLogobtn(!logobtn)} 
                    className="w-10  rounded-full  border-4 border-red-700 " src="/src/assets/logo/logo.jpg" alt="user photo"/>
                </button>
    {/* <!-- Dropdown menu --> */}
                ...
                <button onClick={() =>setLsmenu(!lsmenu)}
            ...
            <div className={`items-center justify-between ${lsmenu && "hidden"} w-full md:flex md:w-auto md:order-1`} id="navbar-user">
